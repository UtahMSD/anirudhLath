...
// Class:  CS 6013
//
// Example of using pipe, dup2, and fork/exec.  
//  Example 1) How to use dup2 to replace cout (stdout) with a file.
//  Example 2) How to fork a process and use 'pipe' to be able to send
//               messages from the parent to the child.
//
////////////////////////////////////////////////////////////////
